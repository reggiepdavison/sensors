...
import ca.rpdavison.sensors2.content.SensorListContent;
...
ø
    private void setupRecyclerView(@NonNull RecyclerView recyclerView) {
        ...
        SensorListContent content = new SensorListContent(sensors);

        recyclerView.setAdapter(new SimpleItemRecyclerViewAdapter(this, SensorListContent.SENSORS, mTwoPane));
    }
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        private final List<SensorListContent.SensorDetail> mValues;
        private final boolean mTwoPane;
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                SensorListContent.SensorDetail item = (SensorListContent.SensorDetail) view.getTag();
                if (mTwoPane) {
        ...
        SimpleItemRecyclerViewAdapter(SensorListActivity parent,
                                      List<SensorListContent.SensorDetail> items,
                                      boolean twoPane) {
            mValues = items;
